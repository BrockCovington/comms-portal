...
// The actual thread list now lives in the sidebar column (ThreadListColumn,
// swapped in by Sidebar.tsx while on /threads) — this is just the "nothing
    ...
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="flex flex-1 items-center justify-center">
        <div className="text-center">
          <p className="text-sm font-medium text-[var(--color-ink)]">Pick a thread to view</p>
